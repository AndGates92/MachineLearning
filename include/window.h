...
/**
 * @brief Function: void set_pixels(window_t ** window, unsigned char * pixels)
 *
 * \param window: input window data structure window_t
 * \param pixels: pixels of the window
 *
...
/**
 * @brief Function: unsigned char * get_pixels(window_t * window)
 *
 * \param window: input window data structure window_t
...
/**
 * @brief Function: unsigned char * get_img(window_t * window, int img_no)
 *
 * \param window: input window data structure window_t
